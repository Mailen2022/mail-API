...
export class MailController {
  ...
  @UseInterceptors(
    FileFieldsInterceptor([
      { name: 'organigrama', maxCount: 15 },
      { name: 'geolocalizacion', maxCount: 15 },
      { name: 'comprobante_domicilio', maxCount: 15 },
      { name: 'constancia_domicilio_fiscal', maxCount: 15 },
      { name: 'estatuto_social', maxCount: 15 },
      { name: 'acta_constitucion', maxCount: 15 },
      { name: 'ultima_acta_designacion', maxCount: 15 },
      { name: 'comprobante_cuit', maxCount: 15 },
      { name: 'constancia_inscripcion', maxCount: 15 },
      { name: 'estados_financieros', maxCount: 15 },
      { name: 'constancia_bancaria', maxCount: 15 },
      { name: 'libro_acciones', maxCount: 15 },
      { name: 'docs_identidad_socios', maxCount: 15 },
      { name: 'manifestacion_bienes', maxCount: 15 },
      { name: 'dni_representantes', maxCount: 15 },
      { name: 'poder_notarial', maxCount: 15 },
    ]),
  )
